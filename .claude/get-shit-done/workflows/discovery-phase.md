...
See /Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/discovery.md
...
Use /Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/discovery.md.
