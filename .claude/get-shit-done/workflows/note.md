...
- **Global scope**: `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/notes/`)
...
2. Glob `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/notes/` — works in any directory
