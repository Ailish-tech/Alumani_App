...
- Usage: Reference from command with `@/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
