...
<!-- For checkpoint task examples and patterns, see @/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
