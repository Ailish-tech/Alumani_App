...
Reference full template: `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/state.md`.
