...
Use template from `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Volumes/AdnaanSSD/Mac Download/Alumani App/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
