...
import { getChatRooms, getChatMessages, createOrGetRoom } from '../controllers/chatController';
...
router.post('/rooms', authMiddleware, (req, res, next) =>
  createOrGetRoom(req as AuthenticatedRequest, res, next)
);
